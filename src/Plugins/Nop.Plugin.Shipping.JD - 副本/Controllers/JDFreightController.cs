...
namespace Nop.Plugin.Shipping.JDFreight.Controllers
{
    ...
    public class JDFreightController : BasePluginController
    {
        ...
        private readonly JDSettings _fixedOrByWeightSettings;
        ...
        {
            var rate = _settingService.GetSettingByKey<decimal>(string.Format("ShippingRateComputationMethod.JD.Rate.ShippingMethodId{0}", shippingMethodId));
            return rate;
        }
