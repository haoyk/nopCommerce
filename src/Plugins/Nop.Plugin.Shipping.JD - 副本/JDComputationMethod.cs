...
namespace Nop.Plugin.Shipping.JDFreight
{
    ...
    /// </summary>
    public class JDComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        #region Fields
        ...
        {
            throw new Exception("暂不支持固定费额运费");
        }
        ...
        {
            //settings
            _settingService.DeleteSetting<JDSettings>();
