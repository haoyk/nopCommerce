...
using Nop.Plugin.Shipping.JDFreight.Models;
...
namespace Nop.Plugin.Shipping.JDFreight.Controllers
{
    [AdminAuthorize]
    public class JDFreightController : BasePluginController
    {
        ...
        public JDFreightController(IShippingService shippingServicee,
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Shipping.JDFreight/Views/Configure.cshtml", model);
        }
        ...
        public ActionResult UpdateFixedShippingRate(FixedRateModel model)
        {
            ...
            _settingService.SetSetting(string.Format("ShippingRateComputationMethod.JDFreight.Rate.ShippingMethodId{0}", shippingMethodId), rate);
        ...
        {
            var rate = _settingService.GetSettingByKey<decimal>(string.Format("ShippingRateComputationMethod.JDFreight.Rate.ShippingMethodId{0}", shippingMethodId));
            return rate;
        }
        ...
        public ActionResult RateByWeightList(DataSourceRequest command)
        {
            ...
            var sbwModel = records.Select(x =>
            {
                ...
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.From"), m.From);
                htmlSb.Append("<br />");
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.To"), m.To);
                htmlSb.Append("<br />");
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.AdditionalFixedCost"), m.AdditionalFixedCost);
                htmlSb.Append("<br />");
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.RatePerWeightUnit"), m.RatePerWeightUnit);
                htmlSb.Append("<br />");
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.LowerWeightLimit"), m.LowerWeightLimit);
                htmlSb.Append("<br />");
                htmlSb.AppendFormat("{0}: {1}", _localizationService.GetResource("Plugins.Shipping.JDFreight.Fields.PercentageRateOfSubtotal"), m.PercentageRateOfSubtotal);
